/**
 * Workers Error Handler - Adapts ErrorHandler for Workers environment
 */

import { AppError, ErrorType, UserFriendlyError } from '../types.js'
...
export class WorkersErrorHandler {
  ...
  /**
   * Create error response for Workers
   */
