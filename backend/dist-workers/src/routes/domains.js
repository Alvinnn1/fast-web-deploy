...
export async function domainsRoutes(fastify) {
    ...
    fastify.post('/api/domains', async (request, reply) => {
        try {
            ...
            return ResponseFormatter.success(domain, 'Domain created successfully');
        }
        catch (error) {
            return ErrorHandler.handleRouteError(reply, error);
        }
    });
    fastify.get('/api/domains/:id', async (request, reply) => {
        try {
            ...
            return ResponseFormatter.success(domainDetail, 'Domain details retrieved successfully');
        }
        catch (error) {
            return ErrorHandler.handleRouteError(reply, error);
        }
    });
    fastify.get('/api/domains/:id/dns-records', async (request, reply) => {
        try {
            const { id } = request.params;
            if (!id || typeof id !== 'string') {
                throw ErrorHandler.createValidationError('Domain ID is required');
            ...
            return ResponseFormatter.success(transformedRecords, 'DNS records retrieved successfully');
        }
        catch (error) {
            return ErrorHandler.handleRouteError(reply, error);
        }
    });
    fastify.post('/api/domains/:id/dns-records', async (request, reply) => {
        try {
            const { id } = request.params;
    ...
    fastify.put('/api/domains/:id/dns-records/:recordId', async (request, reply) => {
        try {
            ...
            return ResponseFormatter.success(transformedRecord, 'DNS record updated successfully');
        }
        catch (error) {
            return ErrorHandler.handleRouteError(reply, error);
        }
    });
    fastify.delete('/api/domains/:id/dns-records/:recordId', async (request, reply) => {
        try {
            const { id, recordId } = request.params;
            if (!id || typeof id !== 'string') {
                throw ErrorHandler.createValidationError('Domain ID is required');
            ...
            return ResponseFormatter.success({ id: recordId }, 'DNS record deleted successfully');
        }
        catch (error) {
            return ErrorHandler.handleRouteError(reply, error);
        }
    });
    fastify.post('/api/domains/:id/ssl-certificate', async (request, reply) => {
        try {
            const { id } = request.params;
            if (!id || typeof id !== 'string') {
                throw ErrorHandler.createValidationError('Domain ID is required');
            ...
            return ResponseFormatter.success(transformedCertificate, 'SSL certificate requested successfully');
        }
        catch (error) {
            return ErrorHandler.handleRouteError(reply, error);
        }
